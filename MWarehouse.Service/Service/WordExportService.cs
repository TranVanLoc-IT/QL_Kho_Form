...
namespace MWarehouse.Service.Service
{
    public class WordExportService: IWordExportService
    {
        ...
        public void QuyetDinhKhenThuong(string pNgay, string pThang, string pNam, string pHoVaTen, string pSoQD)
        {
            ...
            string[] fields = new string[] { "Ngay", "Thang", "Nam", "HoVaTen", "SoQuyetDinh" };
        ...
        public void ThongTinSinhVien(object sv)
        {
            #region ===== Core======
            MemoryStream mStream = null;
            WordDocument document = null;
            ...
            {
                // Read template
                mStream = new MemoryStream(File.ReadAllBytes("BieuMau_ThongTinSV.docx").ToArray());// I
                document = new WordDocument(mStream);
                mStream.Close();
            }
            catch
            ...
            fileBoNhiem = Global.AppPath + Constants.FOLDER_TEMP +
                            Constants.CHAR_FLASH + "BieuMau_ThongTinSV" + Constants.FILE_EXT_DOC;// II
            ...
            string[] fields = new string[] { "MaSinhVien", "HoTen", "NgaySinh", "MaLop" };


            //string[] values = new string[] { sv.MaSinhVien, sv.HoTen, sv.NgaySinh.ToString(), sv.MaLop };
